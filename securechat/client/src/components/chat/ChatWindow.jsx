...
import { Shield, MessageSquare, QrCode, Sparkles } from 'lucide-react';

export function ChatWindow({ socket }) {
  const { user } = useAuthStore();
  const { activeConversation, activeMessages, setActiveMessages, addMessage, onlineUsers } = useChatStore();
